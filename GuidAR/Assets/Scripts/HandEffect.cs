...
public class HandEffect : MonoBehaviour
{
    ...
    void OnHumanBodiedChaned(ARHumanBodiesChangedEventArgs eventArgs)
    {
        foreach (ARHumanBody humanBody in eventArgs.updated)
        {
            ...
            {
                if (joint.index == (int)JointIndices.LeftHandIndexEnd || joint.index == (int)JointIndices.RightHandIndexEnd)
                {
                ...
                if (joint.index == (int)JointIndices.RightLeg)
                {
